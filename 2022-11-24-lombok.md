...
## **結論**
雖然 Lombok 雖然很方便，但世上沒有十全十美的工具，也沒有完美的用法，開發者們不僅要懂得取捨，也要看使用場合。此外，我們也要明白 Lombok 到底做了什麼，並且不要標記過多的 annotation 讓程式看起來更複雜（尤其是有邏輯的地方），否則萬一出了問題就會很麻煩。
總結來說，Lombok 用法並沒有標準答案，青菜蘿蔔各有所好。只要能符合本身需求，又考慮到可讀性與維護成本，並且盡量減少出錯的風險，就是個好的用法。

...
## **違反 KISS 原則的案例探討**
有些決策者沒有考慮周全，一味的使用難度較高的技術，看似能解決問題，卻也導致將產品帶往複雜的方向並且難以回頭。例如，因應業務成長，架構師可能會將單體架構轉為微服務架構，雖然能提升系統的承載力，但維運、開發成本也會大幅提升。因為，一個微服務架構除了本來的服務外，還要包含服務註冊、API Gateway、監控系統等。從一個服務變成一個生態系，是相當有挑戰性的任務 !

...
單元測試已是軟體工程師必備的技能，但在我的經驗中，有些人寫的單元測試看起煞有其事，實際上卻沒測到重點，而且還容易因為重構而導致測試失敗，可說是為了測試而測試。這樣的不僅不會帶來好處，反而還使專案更不穩健，因此遵循測試的 Best Practice 是很重要的。本文將介紹 Java Unit Test 最佳實踐與案例，並提出許多人遭遇的盲點。
